...
public class TestShell {
	...
	private ShellSort implementation;
	
	@Before
	public void setUp() throws Exception {
		implementation = new ShellSort();
	...
	public void testQuickSortTC01() {
		...
		implementation.shellSort(vetor1);
		Arrays.sort(copy1);
	...
	public void testQuickSortTC02() {
		...
		implementation.shellSort(vetor2);
		Arrays.sort(copy1);
	...
	public void testQuickSortTC03() {
		...
		implementation.shellSort(vetor3);
		Arrays.sort(copy1);
	...
	public void testQuickSortTC04() {
		...
		implementation.shellSort(vetor4);
		Arrays.sort(copy1);
	...
	public void testQuickSortTC05() {
		...
		implementation.shellSort(vetor5);
		Arrays.sort(copy1);
	...
	public void testQuickSortTC06() {
		...
		implementation.shellSort(vetor6);
		Arrays.sort(copy1);
	...
	public void testQuickSortTC07() {
		...
		implementation.shellSort(vetor7);
		Arrays.sort(copy1);
	...
	public void testWithRandomNumbers() {
		...
		for (int i = 0; i < 20; i++) {
			...
			Arrays.sort(copy1);
			implementation.shellSort(array);
